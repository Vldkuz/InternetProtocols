...
class DNSParser:
    def __init__(self, bytes_stream: bytes):
        ...
        # TTL - 32 бита
        # RDLENGTH = 16 бит
        # RDATA = значение RDLENGTH

        self._Queries = []

        seek = HEADER_SIZE

        # Здесь парсим Question до посинения (пока количество записей не будет равно количеству запросов в заголовке)
        ...
        # Идентично записи выше, только запрос = ответ
